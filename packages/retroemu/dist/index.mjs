...
function Ee(e) {
  ...
  const a = e.gameName ? ye(e.gameName) : void 0;
...
class Ce {
  ...
  render(n) {
    this.teardownRender();
    const a = n, i = Ee(a), o = Math.round(a.height ?? he), r = new AbortController();
    this.renderAbort = r;
    ...
    if (t.className = "retroemu", t.style.setProperty("--retroemu-height", `${o}px`), i) {
      ...
      l.className = "screen", l.title = `${i.gameName} GBA emulator`, l.setAttribute("allow", "autoplay; fullscreen; gamepad"), l.srcdoc = Ue(i), this.frame = l, t.append(l, this.createController(r.signal)), this.state = { gameName: i.gameName, romUrl: i.romUrl };
    } else
